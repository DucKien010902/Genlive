...
const FINAL_FOOTER_DATA = {
  Headquarter:
    "GENLIVE Studio, CT3 Building, Nghia Do Urban Area, Alley 106 Hoang Quoc Viet Street, Nghia Do District, Hanoi.",
  GoogleMapLink:
    ...
    <>
      ...
      <section className="bg-white py-16 px-4 md:px-8 flex flex-col items-center border-t border-gray-200">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start justify-between w-full">
          ...
          {/* Right Side */}
          <div className="lg:w-1/2 text-sm text-gray-700 leading-relaxed text-left sm:text-right">
            <p
              className="font-bold text-2xl mb-4 flex items-center whitespace-nowrap justify-left sm:justify-end"
              style={{ color: TEXT_DARK_COLOR }}
            >
              GEN
              {/* <FaDotCircle
      ...
      {/* Cookie Banner */}
      {showCookieBanner && (
        <div className="sticky bottom-0 left-0 right-0 bg-gray-100 dark:bg-gray-800 text-center text-xs sm:text-lg p-3 text-gray-600 dark:text-gray-400 z-40 shadow-inner">
          <span>

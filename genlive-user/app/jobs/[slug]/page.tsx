...
const JobPostingFull = () => {
  ...
  if (!jobData) {
    return <div style={{ minHeight: 600 }}>Đang tải dữ liệu công việc...</div>;
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1
            className="text-2xl sm:text-3xl font-bold uppercase mb-2 leading-tight" // ✅ Cỡ chữ responsive
            style={{ color: PRIMARY_COLOR }}
          >
            {title}
          </h1>
        ...
        <section className="mb-10">
          <h2
            className="text-xl sm:text-2xl font-bold mb-4" // ✅ Cỡ chữ responsive
            style={{ color: PRIMARY_COLOR }}
          >
            Job Information
          </h2>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-4">
  ...
  />
        ...
        {/* Các section còn lại (Giả định SectionHeader và DetailList đã responsive) */}
        <section className="mb-10">
        ...
        <section className="mb-10">
          <h3
            className="text-lg sm:text-xl font-bold mb-4" // ✅ Cỡ chữ responsive
            style={{ color: PRIMARY_COLOR }}
          >
            {contactTitle}
          </h3>
        ...
        <footer className="py-4 flex flex-col sm:flex-row justify-between items-center mt-6 gap-6">
          {" "}
          {/* ✅ flex-col (mobile) và sm:flex-row (tablet+) */}
          <button
            className="text-white font-semibold py-2 px-6 rounded-lg transition duration-300 shadow-md w-full sm:w-auto cursor-pointer" // ✅ Nút full-width trên mobile

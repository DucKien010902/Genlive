...
const PRIMARY_COLOR_HOVER = "#a01620"; // Màu đậm hơn khi hover
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-right">
              <a
                ...
                onMouseOver={(e) => e.currentTarget.style.color = PRIMARY_COLOR_HOVER}
            ...
            <button
              ...
              onMouseOver={(e) => e.currentTarget.style.backgroundColor = isLoading ? "#ef4444" : PRIMARY_COLOR_HOVER}
              onMouseOut={(e) => e.currentTarget.style.backgroundColor = isLoading ? "#ef4444" : PRIMARY_COLOR}
            >
              {isLoading ? (
                // Hiệu ứng loading
                <svg
